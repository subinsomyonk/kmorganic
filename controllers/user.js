...
exports.postUpdateProfile = (req, res, next) => {
    ...
    // if (!validator.isEmpty(req.body.name)) validationErrors.push({ msg: 'Please enter a valid name.' });
    if (!validator.isInt(req.body.level)) validationErrors.push({ msg: 'Please enter a number of level.' });
